<?php
    ...
    class Error_client {
        ...
        public function consulta() {
            $con = "SELECT * FROM error_cliente ORDER BY id_error";
        ...
        public function insertar($params) {
            $ins = "INSERT INTO error_cliente(FO_error, FO_cliente) VALUES('$params->FO_error', '$params->FO_cliente')";
        ...
        public function eliminar($id) {
            $del = "DELETE FROM error_cliente WHERE id_error = $id";
        ...
        public function editar($id, $params) {
            $editar = "UPDATE error_cliente SET FO_error = '$params->FO_error', FO_cliente = '$params->FO_cliente' 
                       WHERE id_error = $id";
        ...
        public function filtrar($valor) {
            $filtro = "SELECT * FROM error_cliente WHERE id_error LIKE '%$valor%' OR FO_error LIKE '%$valor%'";
