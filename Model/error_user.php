<?php
    ...
    class Error_user {
        ...
        public function consulta() {
            $con = "SELECT * FROM error_usuario ORDER BY id_error";
        ...
        public function insertar($params) {
            $ins = "INSERT INTO error_usuario(FO_error, FO_usuario) VALUES('$params->FO_error', '$params->FO_usuario')";
        ...
        public function eliminar($id) {
            $del = "DELETE FROM error_usuario WHERE id_error = $id";
        ...
        public function editar($id, $params) {
            $editar = "UPDATE error_usuario SET FO_error = '$params->FO_error', FO_usuario = '$params->FO_usuario' 
                       WHERE id_error = $id";
        ...
        public function filtrar($valor) {
            $filtro = "SELECT * FROM error_usuario WHERE id_error LIKE '%$valor%' OR FO_error LIKE '%$valor%'";
