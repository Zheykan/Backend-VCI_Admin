<?php
    ...
    class Error_purchase {
        ...
        public function consulta() {
            $con = "SELECT * FROM error_compra ORDER BY id_error";
        ...
        public function insertar($params) {
            $ins = "INSERT INTO error_compra(FO_error, FO_compra) VALUES('$params->FO_error', '$params->FO_compra')";
        ...
        public function eliminar($id) {
            $del = "DELETE FROM error_compra WHERE id_error = $id";
        ...
        public function editar($id, $params) {
            $editar = "UPDATE error_compra SET FO_error = '$params->FO_error', FO_compra = '$params->FO_compra' 
                       WHERE id_error = $id";
        ...
        public function filtrar($valor) {
            $filtro = "SELECT * FROM error_compra WHERE id_error LIKE '%$valor%' OR FO_error LIKE '%$valor%'";
