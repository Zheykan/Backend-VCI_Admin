<?php
    ...
    class Error_product {
        ...
        public function consulta() {
            $con = "SELECT * FROM error_producto ORDER BY id_error";
        ...
        public function insertar($params) {
            $ins = "INSERT INTO error_producto(FO_error, FO_producto) VALUES('$params->FO_error', '$params->FO_producto')";
        ...
        public function eliminar($id) {
            $del = "DELETE FROM error_producto WHERE id_error = $id";
        ...
        public function editar($id, $params) {
            $editar = "UPDATE error_producto SET FO_error = '$params->FO_error', FO_producto = '$params->FO_producto' 
                       WHERE id_error = $id";
        ...
        public function filtrar($valor) {
            $filtro = "SELECT * FROM error_producto WHERE id_error LIKE '%$valor%' OR FO_error LIKE '%$valor%'";
