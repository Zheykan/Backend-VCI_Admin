<?php
    ...
    class Error_mark {
        ...
        public function consulta() {
            $con = "SELECT * FROM error_marca ORDER BY id_error";
        ...
        public function insertar($params) {
            $ins = "INSERT INTO error_marca(FO_error, FO_marca) VALUES('$params->FO_error', '$params->FO_marca')";
        ...
        public function eliminar($id) {
            $del = "DELETE FROM error_marca WHERE id_error = $id";
        ...
        public function editar($id, $params) {
            $editar = "UPDATE error_marca SET FO_error = '$params->FO_error', FO_marca = '$params->FO_marca' 
                       WHERE id_error = $id";
        ...
        public function filtrar($valor) {
            $filtro = "SELECT * FROM error_marca WHERE id_error LIKE '%$valor%' OR FO_error LIKE '%$valor%'";
